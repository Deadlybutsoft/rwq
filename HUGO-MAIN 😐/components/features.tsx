      ...
      >
        ...
        <div>
          <div className="grid grid-cols-12 gap-4 justify-center">
            {/* Cli */}
            <motion.div
              className="group border-white/10 text-card-foreground relative col-span-12 flex flex-col overflow-hidden rounded-xl border from-secondary/40 to-secondary/10 bg-gradient-to-b p-6 shadow-[0px_2px_0px_0px_rgba(255,255,255,0.1)_inset] transition-all ease-in-out md:col-span-6 xl:col-span-6 xl:col-start-2"
            ...
            {/* Global */}
            <motion.div
              className="group border-white/10 text-card-foreground relative col-span-12 flex flex-col overflow-hidden rounded-xl border from-secondary/40 to-secondary/10 bg-gradient-to-b p-6 shadow-[0px_2px_0px_0px_rgba(255,255,255,0.1)_inset] transition-all ease-in-out md:col-span-6 xl:col-span-6 xl:col-start-8"
            ...
            <motion.div
              ...
              whileHover={{
                borderColor: "rgba(208, 254, 23, 0.5)",
                boxShadow: "0 0 30px rgba(208, 254, 23, 0.2)",
              }}
              style={{ transition: "all 0s ease-in-out" }}
            >
                  ...
                  <div className="relative rounded-2xl border border-white/10 bg-black/20 dark:bg-white/5 backdrop-blur-sm">
                    ...
                    <div className="flex items-center justify-between px-4 pb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <button className="flex items-center gap-2 px-4 py-2 rounded-full bg-[#D0FE17] hover:bg-[#D0FE17]/90 transition-colors text-black font-medium">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                            height="16"
