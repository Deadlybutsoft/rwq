        ...
        <div className="flex items-center justify-between mt-2">
          ...
          <div className="flex items-center gap-1 shrink-0">
            <button
              ...
              className={cls(
                "inline-flex shrink-0 items-center justify-center gap-2 rounded-md bg-green-500 h-8 w-8 text-sm font-medium text-white shadow-sm transition hover:bg-green-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500 dark:bg-green-500 dark:text-white dark:hover:bg-green-600",
